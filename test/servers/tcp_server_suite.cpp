...
struct A_Running_Passive_Server
{
    A_Running_Passive_Server() : s(Tcp_Server::Role_t::Passive, port_int) {}
...
BOOST_AUTO_TEST_SUITE( tcp_server_suite )
    ...
    BOOST_FIXTURE_TEST_SUITE( passive_role, A_Running_Passive_Server )
